...
<head>
	...
	<link rel="stylesheet" href="/src/css/contactenos-style.css">
</head>
			...
			<div class="col-12">
				...
				<section class="row justify-content-around my-5">
					...
					<div class="col-12 col-md-10 text-center">
						...
						<p>Sabemos que siempre pueden haber dudas sobre el servicio. Lo invitamos a colocarse en contacto. Lo atenderemos lo más pronto posible.</p>
					</div>
					
				</section>
				<section class="row justify-content-around mb-5">
					<div class="col-md-3 text-center">
						<svg class="icon-contacto" viewBox="0 0 24 24">
							<path fill="currentColor" d="M6.62,10.79C8.06,13.62 10.38,15.94 13.21,17.38L15.41,15.18C15.69,14.9 16.08,14.82 16.43,14.93C17.55,15.3 18.75,15.5 20,15.5A1,1 0 0,1 21,16.5V20A1,1 0 0,1 20,21A17,17 0 0,1 3,4A1,1 0 0,1 4,3H7.5A1,1 0 0,1 8.5,4C8.5,5.25 8.7,6.45 9.07,7.57C9.18,7.92 9.1,8.31 8.82,8.59L6.62,10.79Z" />
						</svg>

						<a class="link-contacto" href="tel:573124105114" target="_blank">312 4105114</a>
					</div>
					...
					<div class="col-md-3 text-center">
						...
						<a class="link-contacto" href="https://wa.me/573124105114?text=Me%20Hola" target="_blank">312 410 5114</a>
					</div>
					...
					<div class="col-md-4 text-center">
						...
						<div class="row">
							...
							<a class="link-contacto" href="mailto:juridica@lexeris.com" target="_blank">juridica@lexeris.com</a>  -  
							<a class="link-contacto" href="mailto:servicioalcliente@lexeris.com" target="_blank">servicioalcliente@lexeris.com</a>
						</div>
