...
<head>
	...
	<title>Asesoria empresarial - Lexeris</title>
	...
	<link rel="stylesheet" href="/src/css/nuestros-servicios/asesoria-style.css">
</head>
...
<body>
	...
	<div class="container-fluid">
		...
		<main class="row">
			<div class="col-12">
				...
				<section class="row" id="ae-background">
					<div class="col-md-6 offset-md-1 my-5">
						<div class="row align-items-center h-100 " id="ae-container">
							<div class="col-12">
							<h3>ASESORÍA EMPRESARIAL</h3>
								<p>En LEXERIS queremos ser aliados estratégicos de su negocio.</p>
								...
								<ul>
									...
									<li>
										...
										Especialistas en distintos campos de derecho.
									</li>
								...
								<div class="row justify-content-center my-2">
									<button class="btn btn-cta">
										<a href="https://wa.me/573124105114?text=Me%20interesa%20el%20servicio%20de%20asesoria%20empresarial">Más información <br> CONSULTA PERSONALIZADA</a>
									</button>
								</div>
							</div>
						</div>
					...
					<div class="col-12 text-center">
						...
						<div class="row justify-content-around">
							<div class="pasos-item">
								...
								<span>CUÉNTENOS SU PROBLEMA (CHAT O VIDEO-CONFERENCIA)</span>
							</div>
							<div class="pasos-item">
								<svg style="width:48px;height:48px" viewBox="0 0 24 24">
								...
								<span>ESCOJA UNA FECHA Y EL/ABOGADO</span>
							</div>
							<div class="pasos-item">
								<svg style="width:48px;height:48px" viewBox="0 0 24 24">
				...
				<div class="row text-center my-4">
					...
					<div class="col-md-6">
						<div class="row justify-content-center">
							<div class="razones-item d-flex justify-content-center align-items-center">
								<p>
									TIEMPO DE ASESORIA
								</p>
							</div>
					...
					<div class="col-md-6">
						<div class="row justify-content-center">
							<div class="razones-item d-flex justify-content-center align-items-center">
								<p>
									SOPORTE LEGAL TODOS LOS DÍAS
								</p>
							</div>
							<div class="razones-item d-flex justify-content-center align-items-center">
								<p>
									EQUIPOS INTERDISCIPLINARIOS EJEMPLO: EQUIPO TRIBUTARIO ABOGADO + CONTADOR
								</p>
							</div>
							<div class="razones-item d-flex justify-content-center align-items-center">
								<p>
									NUESTRO SISTEMA PERMITE OTORGAR UNA <b>RESPUESTA RÁPIDA</b> AL CLIENTE
								</p>
							</div>
							<div class="razones-item d-flex justify-content-center align-items-center">
								<p>
									NUESTRO SISTEMA ASEGURA <b>DOCUMENTOS APROPIADOS</b> A SU PROBLEMA
								</p>
							</div>
						</div>
					</div>
	...
	<?php include_once $_SERVER["DOCUMENT_ROOT"] . '/src/commons/common-scrits-caller.php' ;?>
