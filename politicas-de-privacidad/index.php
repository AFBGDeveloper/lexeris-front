...
<head>
	...
	<title>Políticas de privacidad - Lexeris</title>
		...
		<main class="row justify-content-center">
			<section class="col-12">
				<div class="row justify-content-center my-4">
					<h2>POLÍTICAS DE PRIVACIDAD - LEXERIS</h2>
				</div>
			</section>
			<section class="col-10">
				<iframe src="https://docs.google.com/gview?url=https://lexeris.com/src/docs/politicas-de-privacidad.docx&amp;embedded=true" style="width:100%; height:800px" frameborder="0"></iframe>
			</section>
		</main>
